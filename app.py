...
st.set_page_config(
    ...
    page_icon="🌿",
    layout="centered", # You can also specify layout, initial_sidebar_state, etc.
)
...
def main():
    ...
    st.warning(" Check the source code [here](https://github.com/gabbygab1233/Crop-Recommendation)")
    hide_menu_style = """
    <style>
